...
class PortFoliesController extends ActionController{
 ...
 public  $id;
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getPortFolies($request, $response, $args = []){
        try {
           
            $PortFoli="{\n    \"status\": \"success\",\n    \"result\": [\n        {\n            \"version\": \"3.0\"\n        }\n    ]\n";
            $PortFolies= json_decode($PortFoli);
            return $response->withJson(ResponseFormatter::successResponse($PortFolies, 'result'));
