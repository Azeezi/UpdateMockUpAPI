...
class IsMMFAccountController extends ActionController{
 ...
 public  $id;
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getIsMMFAccount($request, $response, $args = []){
        try {
           
            $IsMMFAccounts="{\n    \"status\": \"success\",\n    \"result\": [\n        {\n            \"version\": \"3.0\"\n        }\n    ]\n";
            $IsMMFAccount= json_decode($IsMMFAccounts);
            return $response->withJson(ResponseFormatter::successResponse($IsMMFAccount, 'result'));
