...
class ChequeStatussController extends ActionController{
    ...
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getChequeStatuss($request, $response, $args = []){
        try {
            ...
            $ChequeStatuss= json_decode(($ChequeStatus));
            return $response->withJson(ResponseFormatter::successResponse($ChequeStatuss, 'result'));
