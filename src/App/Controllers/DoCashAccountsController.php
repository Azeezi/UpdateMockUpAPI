...
class    DoCashAccountsController extends ActionController{
    ...
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getDoCashAccounts($request, $response, $args = []){
        try {
            ...
            $DoCashAccounts= json_decode(($DoCashAccount));
            return $response->withJson(ResponseFormatter::successResponse($DoCashAccounts, 'result'));
