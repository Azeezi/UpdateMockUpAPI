...
class DoFundAccountsController extends ActionController{
 ...
 public  $id;
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getDoFundAccounts($request, $response, $args = []){
        try {
           
            $DoFundAccount="{\n    \"status\": \"fail\",\n    \"result\": [\n        {\n            \"code\": \"00500\",\n            \"remarks\": \"System error encountered\"\n        }\n    ]\n}";
            $DoFundAccounts= json_decode($DoFundAccount);
            return $response->withJson(ResponseFormatter::successResponse($DoFundAccounts, 'result'));
