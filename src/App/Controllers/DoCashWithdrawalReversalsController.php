...
class DoCashWithdrawalReversalsController extends ActionController{
 ...
 public  $id;
    ...
    public function getDoCashWithdrawalReversals($request, $response, $args = []){
        try {
        $DoCashWithdrawalReversal= "{\n    \"status\": \"fail\",\n    \"result\": [\n        {\n            \"code\": \"502\",\n            \"remarks\": \"Original transaction record not found\"\n        }\n    ]\n}";   
        $DoCashWithdrawalReversals=json_decode(($DoCashWithdrawalReversal));
        
        return $response->withJson(ResponseFormatter::successResponse($DoCashWithdrawalReversals, 'result'));
