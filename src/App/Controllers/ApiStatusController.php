...
class ApiStatusController extends ActionController{
 ...
 public  $id;
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getApiStatus($request, $response, $args = []){
        try {
           
            $ApiState="{\n    \"status\": \"success\",\n    \"result\": [\n        {\n            \"version\": \"3.0\"\n        }\n    ]\n";
            $ApiStatus= json_decode($ApiState);
            return $response->withJson(ResponseFormatter::successResponse($ApiStatus, 'result'));
