...
class UpdatesController extends ActionController{
 ...
 public  $id;
    public function __invoke($request, $response, $args = [])
    {
     ...
     public function getUpdates($request, $response, $args = []){
        try {
           
            $Update="{\n    \"status\": \"success\",\n    \"result\": [\n        {\n            \"Update Running\": \"FALSE\"\n        }\n    ]\n}";
            $Updates= json_decode($Update);
            return $response->withJson(ResponseFormatter::successResponse($Updates, 'result'));
